...
public class SplashScreenFrame extends javax.swing.JFrame {
    ...
    public SplashScreenFrame() {
        ...
        ColorUIResource cui=new ColorUIResource(bkColor);
        UIManager.put("nimbusOrange",cui);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("D:\\JAVA Folder\\Java Project ppt\\TECH QUIZ APP\\onlineexam\\Tech quiz app.png")); // NOI18N
...
class SplashThread extends Thread{
            public void run()
            {
                int count=1;
                Random r=new Random();
                while(jProgressBar1.getMaximum()>jProgressBar1.getValue())
                {
                    try{
                        ...
                        JOptionPane.showMessageDialog(null, "Error in thread "+e, "Error!!!",JOptionPane.ERROR_MESSAGE);
                    }
                }
