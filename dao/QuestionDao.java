...
public class QuestionDao {
    ...
    public static void updateQuestion(ArrayList<QuestionPojo> qs)throws SQLException{
         // ArrayList<QuestionPojo> updateQuest=qs.getAllQuestions();
        Connection conn=DBConnection.getConnection();
       ...
       for(QuestionPojo p:qs){
            ps.setInt(9,p.getQno());
            ...
            ps.setString(8,p.getExamid());
             System.out.println("Hi Your Question Appear in database");
            ps.executeUpdate();
            
              System.out.println("Papepr Setteled Successfully");
